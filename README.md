...
* [Photo Lab sample](https://github.com/Microsoft/Windows-appsample-photo-lab) - ![GitHub stars](https://img.shields.io/github/stars/Microsoft/Windows-appsample-photo-lab?cacheSeconds=604800) ![GitHub last commit](https://img.shields.io/github/last-commit/Microsoft/Windows-appsample-photo-lab?cacheSeconds=86000) (updated to WinUI 2.4 - May 2020) A mini-app for viewing and editing image files, demonstrating XAML layout, data binding, and UI customization features for Universal Windows Platform (UWP) apps.
