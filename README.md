...
[<img src="https://learn.microsoft.com/en-us/windows/apps/images/logo-winui.png" align="right" width="170">](https://microsoft.github.io/microsoft-ui-xaml/)
...
* [DeftSharp.Windows.Input](https://github.com/Empiree/DeftSharp.Windows.Input) - ![GitHub stars](https://img.shields.io/github/stars/Empiree/DeftSharp.Windows.Input?cacheSeconds=604800) ![GitHub last commit](https://img.shields.io/github/last-commit/Empiree/DeftSharp.Windows.Input?cacheSeconds=86000) Lightweight library designed to handle and manage keyboard/mouse input events in Windows UI applications.
...
* [CodeMarkup for WinUI](https://github.com/idexus/CodeMarkup-WinUI) - ![GitHub stars](https://img.shields.io/github/stars/idexus/CodeMarkup-WinUI?cacheSeconds=604800) ![GitHub last commit](https://img.shields.io/github/last-commit/idexus/CodeMarkup-WinUI?cacheSeconds=86000) CodeMarkup for WinUI enables you to build user interfaces declaratively in C# code using fluent methods. With this library, you can create interfaces without the need for XAML.
...
* [DroidNet](https://github.com/abdes/DroidNet) - ![GitHub stars](https://img.shields.io/github/stars/abdes/DroidNet?cacheSeconds=604800) ![GitHub last commit](https://img.shields.io/github/last-commit/abdes/DroidNet?cacheSeconds=86000) DroidNet is a collection of projects using Windows App SDK and WinUI 3, organized in a monorepo. Highlights include, a docking framework, router-based multi-window navigation, window management and decoration, tabbed documents with tear-out, and several toolkits, source generators and libraries to ease the development of WinUI 3 based complex applications. The monorepo supports the development of the Oxygen Game Engine Editor, fully based on WinUI 3. **[$]**
...
* [SPAN Finder](https://github.com/LumiBearStudio/SpanFinder) - ![GitHub stars](https://img.shields.io/github/stars/LumiBearStudio/SpanFinder?cacheSeconds=604800) ![GitHub last commit](https://img.shields.io/github/last-commit/LumiBearStudio/SpanFinder?cacheSeconds=86000) A macOS Finder-style Miller Columns file explorer for Windows built with WinUI 3. Features multi-tab, split view, 10 themes, keyboard-first design, and FTP/SFTP support.
