...
* [Modernizing your .NET app with WinUI3](https://blogs.msmvps.com/bsonnino/2020/12/23/modernizing-your-net-app-with-winui3/) - (December 23, 2020) - In the last post I showed how to use Xaml Islands to modernize your .NET app. As you could see, there are a lot of steps and the procedure is a little clumsy. But now it’s getting better, Microsoft has introduced WinUI 3 and, with that, things are getting better: you don’t need special components to add your WinUI code, you can use the WinUI components directly in you app.
